...
class RpcStatus(object):
    ...
    def message(self):
        ...
        A developer-facing error message, which should be in English. Any user-facing error message should be localized and sent in the [thoughtmachine.rpc.Status.details][thoughtmachine.rpc.Status.details] field, or localized by the client.  # noqa: E501
    ...
    def details(self):
        ...
        A list of messages that carry the error details.  There will be a common set of message types for APIs to use.  # noqa: E501
