...
class V1commonOverrideRestrictions(object):
    ...
    def __init__(self, all=None, restriction_set_ids=None, restriction_set_definition_ids=None, restriction_set_definition_version_ids=None):  # noqa: E501
        """V1commonOverrideRestrictions - a model defined in Swagger"""  # noqa: E501
        self._all = None
    ...
    @property
    def all(self):
        """Gets the all of this V1commonOverrideRestrictions.  # noqa: E501

        The caller can override all restriction checks for a call by setting this field to true.  # noqa: E501

        :return: The all of this V1commonOverrideRestrictions.  # noqa: E501
        :rtype: bool
        """
        return self._all
    ...
    @all.setter
    def all(self, all):
        """Sets the all of this V1commonOverrideRestrictions.

        The caller can override all restriction checks for a call by setting this field to true.  # noqa: E501

        :param all: The all of this V1commonOverrideRestrictions.  # noqa: E501
        :type: bool
        """
    ...
    def restriction_set_ids(self):
        """Gets the restriction_set_ids of this V1commonOverrideRestrictions.  # noqa: E501

        The caller can override restrictions based on restriction sets by passing the restriction set IDs here.  # noqa: E501

        :return: The restriction_set_ids of this V1commonOverrideRestrictions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def restriction_set_ids(self, restriction_set_ids):
        """Sets the restriction_set_ids of this V1commonOverrideRestrictions.

        The caller can override restrictions based on restriction sets by passing the restriction set IDs here.  # noqa: E501

        :param restriction_set_ids: The restriction_set_ids of this V1commonOverrideRestrictions.  # noqa: E501
        :type: list[str]
        """
    ...
    def restriction_set_definition_ids(self):
        """Gets the restriction_set_definition_ids of this V1commonOverrideRestrictions.  # noqa: E501
        ...
        :return: The restriction_set_definition_ids of this V1commonOverrideRestrictions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def restriction_set_definition_ids(self, restriction_set_definition_ids):
        """Sets the restriction_set_definition_ids of this V1commonOverrideRestrictions.

        The caller can override restrictions based on restriction set definitions by passing the restriction set definition IDs here.  # noqa: E501

        :param restriction_set_definition_ids: The restriction_set_definition_ids of this V1commonOverrideRestrictions.  # noqa: E501
        :type: list[str]
        """
    ...
    def restriction_set_definition_version_ids(self):
        """Gets the restriction_set_definition_version_ids of this V1commonOverrideRestrictions.  # noqa: E501
        ...
        :return: The restriction_set_definition_version_ids of this V1commonOverrideRestrictions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def restriction_set_definition_version_ids(self, restriction_set_definition_version_ids):
        """Sets the restriction_set_definition_version_ids of this V1commonOverrideRestrictions.

        The caller can override restrictions based on restriction set definition versions by passing the restriction set definition version IDs here.  # noqa: E501

        :param restriction_set_definition_version_ids: The restriction_set_definition_version_ids of this V1commonOverrideRestrictions.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1commonOverrideRestrictions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1commonOverrideRestrictions):
            return False
