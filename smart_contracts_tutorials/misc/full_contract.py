""" Enter your Description of your Contract here
"""
display_name = 'Enter Contract Display Name Here'
api = '3.0.0'  # This is a V3 Smart Contract
...
parameters = [
    ...
    Parameter(
        name='overdraft_fee',
        shape=NumberShape(
            kind=NumberKind.MONEY, min_value=0, max_value=1, step=0.01),
        level=Level.TEMPLATE,
...
def _charge_overdraft_fee(vault, effective_date):
    ...
    instruction = vault.make_internal_transfer_instructions(
        amount=overdraft_fee, denomination=denomination,
        from_account_id=vault.account_id, from_account_address=DEFAULT_ADDRESS,
        to_account_id=internal_account, to_account_address=DEFAULT_ADDRESS,
        asset=DEFAULT_ASSET, client_transaction_id='{}_OVERDRAFT_FEE'.format(
