    ...
    def test_global_parameter(self):
        ...
        create_global_parameter = {
            "create_global_parameter": {
                ...
                "description": "Default denomination for accounts in this bank",
                "str": ""
            },
            "initial_value": "GBP"  
        }

        events = [vault_caller.SimulationEvent(start, deposit_event),vault_caller.SimulationEvent(start, create_global_parameter)]
